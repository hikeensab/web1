...
<body>
    ...
    <audio class="song" loop autoplay>
        <source src="./music/nosstress.mp3">
        </source>
    ...
    <div class="container">
        <div class="one">
            <h1 class="one">
                Hi
                <span id="name">Diajeng Ardini Rachmawati</span>
            </h1>
        ...
        <div class="four">
            <div class="text-box">
                <p class="hbd-chatbox">
                Happy birthday to youu!! Tetaplah jadi dirimu yang luar biasa.
                </p>
        ...
        <div class="six">
            <img src="./img/ajeng.jpg" alt="profile" class="profile-picture" id="imagePath"/>
            <img src="img/hat.svg" alt="hat" class="hat" />
            <div class="wish">
                <h3 class="wish-hbd">Happy Birthday!</h3>
                <h5 id="wishText">Semoga apa pun yang diharapkan segera tercapai dengan bantuan dan rahmat dari Allah SWT ;)</h5>
            </div>
        </div>
